...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-16 13:31`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d2460dc2-c054-482a-8fc5-bff514104a2b.git
$ cd d2460dc2-c054-482a-8fc5-bff514104a2b
```
